"""
GhostWatch PDF Report Generator
...
def generate_pdf_report(constituency: str, graph_data: dict) -> bytes:
    ...
    try:
        ...
        story.append(Paragraph("GhostWatch Ghost Voter Intelligence Report", subtitle_style))
        ...
        story.append(Paragraph(
            "This report is generated by GhostWatch Intelligence System v4.1 — Anti-Gravity Systems. "
        ...
        content = f"""GHOSTWATCH GHOST VOTER INTELLIGENCE REPORT
{'='*60}
